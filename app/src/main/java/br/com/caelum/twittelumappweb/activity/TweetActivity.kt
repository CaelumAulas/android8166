...
class TweetActivity : AppCompatActivity() {
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        if (requestCode == 123) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "Não vai funcionar o gps", Toast.LENGTH_LONG).show()
            }
    ...
    fun criaTweet(): Tweet {
        ...
        val dono = usuarioViewModel.usuario.value!!

        val (latitude, longitude) = gps.getCoordenadas()

        return Tweet(mensagemDoTweet, dono, latitude, longitude, foto)
    }
